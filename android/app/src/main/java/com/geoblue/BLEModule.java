...
public class BLEModule extends ReactContextBaseJavaModule{
    ...
    public void setName(String name) {
        this.name = name;
        Log.i("BLEModule", "name set to " + name);
    }
...
// displays a dialog requesting user permission to enable Bluetooth.
        ...
        if(mGattServer !=null){
        BluetoothGattService tempService = new BluetoothGattService( UUID.fromString("ebed0e09-033a-4bfe-8dcc-20a04fad944e"), BluetoothGattService.SERVICE_TYPE_PRIMARY);
        BluetoothGattCharacteristic tempChar = new BluetoothGattCharacteristic( UUID.fromString("d0611e78-bbb4-4591-a5f8-487910ae4366"), BluetoothGattCharacteristic.PROPERTY_READ | BluetoothGattCharacteristic.PROPERTY_WRITE | BluetoothGattCharacteristic.PROPERTY_NOTIFY, BluetoothGattCharacteristic.PERMISSION_READ | BluetoothGattCharacteristic.PERMISSION_WRITE);
        ...
        mGattServer.addService(tempService);
        }
